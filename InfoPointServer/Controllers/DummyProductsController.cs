...
[ApiController]
[Route("api/products")]
[Obsolete("Temporary dummy controller, REMOVE LATER and UNCOMMENT ROUTE in ProductsController ")]
public class DummyProductsController : ControllerBase
{
    private readonly IProductService _service;
    private readonly ILogger<ProductsController> _logger;

    public DummyProductsController(IProductService service, ILogger<ProductsController> logger)
    {
        _service = service;
        _logger = logger;
    }
